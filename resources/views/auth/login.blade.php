                    ...
                    <div class="col-lg-4 col-lg-push-4">
                        <div class="bordered-box rounded animated" data-animation="fadeInDown">
                            ...
                            @if (session('pesan'))
                                ...
                                <button  class="btn btn-sm btn-danger" style="text-transform: uppercase;"><strong>Mohon Maaf, </strong> {{ session('pesan') }}</button>

                                    {{-- <strong>Mohon Maaf, </strong> {{ session('pesan') }}. --}}
                                {{-- </div> --}}
                                @endif
                            <form id="login-form" method="POST" action="{{ route('login') }}"
                                ...
                                <div class="form-group mb-10">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control input-2"
                                        required>
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
